...
Pure Python version (no Jupyter magic commands).
"""
...
def main():
    """Main function to run the integrated plotting pipeline."""
    ...
    if test_results:
        ...
        plot_df = prepare_data_for_plotting(test_results, 'train_loss', db, aggregate_seeds=True)
    ...
    print("\n\nExample 1: Plotting train and val loss for batch_size=128, width_mult=1.0")
    ...
    # Save the plot
    plt.savefig('example1_train_val_loss.png', dpi=150, bbox_inches='tight')
    print("Saved plot as 'example1_train_val_loss.png'")
    
    # Example 2: Plot all four metrics
    ...
    plt.savefig('example2_all_metrics.png', dpi=150, bbox_inches='tight')
    print("Saved plot as 'example2_all_metrics.png'")
