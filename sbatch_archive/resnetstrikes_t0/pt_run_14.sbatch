#!/bin/bash
#SBATCH --job-name="prea3_pycil_up50_ep100"
...
CUBLAS_WORKSPACE_CONFIG=:4096:8 python /scratch/ddr8143/repos/dr_gen/scripts/parallel_runs.py -p 8 --start_seed 0 --max_seed 19 --val_bs 500 --proj_name cifar10 --bs 500 --lr 0.01,0.02,0.04 --wd 2.5e-4,5e-4,1e-3 --wtype pretrained --wn resnet18.a3_in1k --xft pycil --use_percent 0.5 --epochs 100
"
