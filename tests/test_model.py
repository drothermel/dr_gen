...
@pytest.mark.parametrize("optim_type, expected_class", [
...
@pytest.mark.parametrize("lrsched_type, expected_class", [
    (None, type(None)),
...
def test_checkpoint_model(tmp_path):
    ...
    mu.checkpoint_model(cfg, model, checkpoint_name, optim=optimizer, lrsched=lr_scheduler)
